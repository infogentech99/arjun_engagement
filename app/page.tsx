    ...
    <>
      ...
      <div className=" bg-[url('/assets/bg_mobile.png')] md:bg-[url('/assets/background.webp')] 3xl:bg-[url('/assets/background.webp')]
        ...
        <div className="pt-22 md:pt-42 lg:pt-70 3xl:pt-90 relative z-10">
          ...
          <div className="flex flex-col justify-center items-center mt-41 md:mt-40 lg:mt-20 pb-20 lg:pb-60 3xl:mt-52">
            <h2 className="eb-garamond font-medium text-[12px] md:text-xl lg:text-base 3xl:text-xl text-center text-[#C26F02]">COUNTDOWN TO OUR BIG DAY</h2>
