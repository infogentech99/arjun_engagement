...
<div className="flex justify-center items-center mt-26 relative z-20">
          ...
          <div className="flex justify-center items-center mt-70 md:mt-26 lg:mt-10 absolute top-12 z-10 3xl:left-[28%] lg:left-[36%]  md:left-[38%] md:top-[65%] lg:top-[0%] left-[32%]">
